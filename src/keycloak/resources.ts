...
export const keycloakResources: Resource[] = [
  ...
  },
  {
    ...
    description: "Get specific identity provider details from Keycloak (specify realm as query parameter)",
    mimeType: "application/json"
  },
  ...
  // ========== EVENT RESOURCES ==========
  {
    ...
    description: "Get events from a Keycloak realm (specify realm and optional filters as query parameters)",
    mimeType: "application/json"
  },
  {
    uri: "keycloak://admin-events",
    name: "Keycloak Admin Events",
    description: "Get admin events from a Keycloak realm (specify realm and optional filters as query parameters)",
    mimeType: "application/json"
  },
