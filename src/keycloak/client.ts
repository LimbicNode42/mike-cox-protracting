...
export class KeycloakClient {
  ...
  private async authenticate(): Promise<void> {
    try {
      ...
      this.adminAxiosInstance.defaults.headers.common['Authorization'] = `Bearer ${this.accessToken}`;
    } catch (error) {
  ...
  async listUsers(args: any = {}): Promise<any> {
    ...
    if (args.briefRepresentation !== undefined) params.append('briefRepresentation', args.briefRepresentation.toString());
  ...
  async updateUser(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `User '${userId}' updated successfully in realm '${realm}'` }],
    };
  }
  ...
  async deleteUser(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `User '${args.userId}' deleted successfully from realm '${realm}'` }],
    };
  }
  ...
  async listClients(args: any = {}): Promise<any> {
    ...
    if (args.first !== undefined) params.append('first', args.first.toString());
    if (args.max !== undefined) params.append('max', args.max.toString());
    if (args.viewableOnly !== undefined) params.append('viewableOnly', args.viewableOnly.toString());
  ...
  async updateClient(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Client '${clientUuid}' updated successfully in realm '${realm}'` }],
    };
  }
  ...
  async deleteClient(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Client '${args.clientUuid}' deleted successfully from realm '${realm}'` }],
    };
  }
  ...
  async createRole(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Role '${roleData.name}' created successfully in realm '${realm}'` }],
    };
  }
  ...
  async updateRole(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Role '${roleName}' updated successfully in realm '${realm}'` }],
    };
  }
  ...
  async deleteRole(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Role '${args.roleName}' deleted successfully from realm '${realm}'` }],
    };
  }
  ...
  async createClientRole(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Client role '${roleData.name}' created successfully in realm '${realm}'` }],
    };
  }
  ...
  async assignRealmRoleToUser(args: any): Promise<any> {
    ...
    // Assign the role
    await this.axiosInstance.post(`/${realm}/users/${args.userId}/role-mappings/realm`, [roleRepresentation]);
    return {
      content: [{ type: 'text', text: `Realm role '${args.roleName}' assigned to user '${args.userId}' in realm '${realm}'` }],
    };
  }
  ...
  async assignClientRoleToUser(args: any): Promise<any> {
    ...
    // First get the role representation
    const roleResponse = await this.axiosInstance.get(`/${realm}/clients/${args.clientUuid}/roles/${args.roleName}`);
    const roleRepresentation = roleResponse.data;
    
    // Assign the role
    await this.axiosInstance.post(`/${realm}/users/${args.userId}/role-mappings/clients/${args.clientUuid}`, [roleRepresentation]);
    return {
      content: [{ type: 'text', text: `Client role '${args.roleName}' assigned to user '${args.userId}' in realm '${realm}'` }],
    };
  }
  ...
  async listGroups(args: any = {}): Promise<any> {
    ...
    if (args.first !== undefined) params.append('first', args.first.toString());
    if (args.max !== undefined) params.append('max', args.max.toString());
    if (args.populateHierarchy !== undefined) params.append('populateHierarchy', args.populateHierarchy.toString());
  ...
  async createGroup(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Group '${groupData.name}' created successfully in realm '${realm}'` }],
    };
  }
  ...
  async updateGroup(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Group '${groupId}' updated successfully in realm '${realm}'` }],
    };
  }
  ...
  async deleteGroup(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Group '${args.groupId}' deleted successfully from realm '${realm}'` }],
    };
  }
  ...
  async createIdentityProvider(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Identity provider '${idpData.alias}' created successfully in realm '${realm}'` }],
    };
  }
  ...
  async getIdentityProvider(args: any): Promise<any> {
    await this.ensureAuthenticated();
    const realm = this.getRealmPath(args.realm);
    const response = await this.axiosInstance.get(`/${realm}/identity-provider/instances/${args.alias}`);
    return {
      content: [{ type: 'text', text: JSON.stringify(response.data, null, 2) }],
    };
  }
  ...
  async updateIdentityProvider(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Identity provider '${alias}' updated successfully in realm '${realm}'` }],
    };
  }
  ...
  async deleteIdentityProvider(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Identity provider '${args.alias}' deleted successfully from realm '${realm}'` }],
    };
  }
  ...
  async createClientScope(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Client scope '${scopeData.name}' created successfully in realm '${realm}'` }],
    };
  }
  ...
  async createAuthenticationFlow(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Authentication flow '${flowData.alias}' created successfully in realm '${realm}'` }],
    };
  }
  ...
  async createOrganization(args: any): Promise<any> {
    ...
    return {
      content: [{ type: 'text', text: `Organization '${orgData.name}' created successfully in realm '${realm}'` }],
    };
  }
