...
export const infisicalResources: Resource[] = [
  // ========== SECRET RESOURCES ==========
  {
    ...
    description:
      'List secrets in an Infisical project environment. Uses default project and environment from .env, or specify workspaceId/projectId and environment as query parameters.',
  ...
  // ========== PROJECT RESOURCES ==========
  {
    ...
    description:
      'List all Infisical projects/workspaces in your organization (uses INFISICAL_ORG_ID from .env)',
    mimeType: 'application/json',
  },
  {
  ...
  // ========== FOLDER RESOURCES ==========
  {
    ...
    description:
      'List folders in an Infisical project environment. Uses default project and environment from .env, or specify workspaceId/projectId and environment as query parameters.',
    mimeType: 'application/json',
  },
  {
  ...
  // ========== AUDIT LOG RESOURCES ==========
  {
    ...
    description:
      'Get audit logs from Infisical organization (specify optional filters as query parameters)',
    mimeType: 'application/json',
  },
];
